...
router.post('/student/login', async (req, res) => {
    var resultUser = await new Promise((resolve, reject)=>{
        model.findStudentByEmail(req.body.email, (results)=>{
            resolve(results);
        })
    })
...
router.post('/student/sign-up', async (req, res) =>{
    ...
    var createdUser = await new Promise((resolve, reject)=>{
        model.createStudent(data, (results)=>{
            resolve(results);
        }
        )
    });
...
router.post('/teacher/login', async (req, res) => {
    var resultUser = await new Promise((resolve, reject)=>{
        model.findTeacherByEmail(req.body.email, (results)=>{
            resolve(results);
        })
    })
...
router.post('/teacher/sign-up', async (req, res) =>{
    ...
    // 시간 남으면 exists user 예외처리도 만들자
    var createdUser = await new Promise((resolve, reject)=>{
            model.createTeacher(data, (results)=>{
                resolve(results);
            }
        )
    });
